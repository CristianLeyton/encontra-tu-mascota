    ...
    <div class="pt-8 pb-2 container mx-auto xl:max-w-6xl">
        ...
        <div class="mt-6 container mx-auto xl:max-w-6xl">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                {{-- Disclaimer --}}
                <div
                    class="flex col-span-full lg:col-span-1 items-center gap-3 bg-white rounded-xl shadow-md px-3 py-2 border border-gray-100">
                ...
                {{-- Fotos propias --}}
                <div class="flex items-center gap-3 bg-white rounded-xl shadow-md px-3 py-2 border border-gray-100">
